...
## More than just for "the next class" {background-color="#ffffff"}
...
- Core message: one place to write and run both R and Python, which lowers the
...
- Take-home: the pandas/dplyr/SQL exercise still lives at
  kathusar.github.io/eCOTS26/lessons/Appendix.html for anyone who wants a ready-made one.
:::
